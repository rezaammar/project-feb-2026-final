...
<div class="container mt-2">
    ...
    <div class="p-3 mb-2 bg-light rounded-3 border shadow-sm">
        <div class="container-fluid py-2">
            <h4 class="fs-3 fw-bold text-primary mb-1">Selamat Datang, {{ $userName }}! di Dashboard Admin</h4>
            <p class="fs-6 text-secondary mb-3">
                Anda memiliki produk yang siap dikelola hari ini.
            </p>
            <hr class="my-2">
            <button class="btn btn-primary btn-sm px-4" href="/admin/upload" type="button">Upload Informasi Saham</button>
        </div>
    </div>  
