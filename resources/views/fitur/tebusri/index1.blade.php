...
<div class="container-fluid">    
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Hitung Jumlah Lot Baru RI</h5>
        </div>

        <div class="card-body">
            <form action="{{ route('hitungLotTebus') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="rasio_kiri" class="form-control" placeholder="" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Rasio Kanan</label>
                    <input type="number" name="rasio_kanan" class="form-control" placeholder="" required>
                </div>
